...
See the [Snakemake documentation](https://snakemake.readthedocs.io/en/latest/) for further details.
...
1. Once, register the upstream repository in your local copy: `git remote add -f upstream git@github.com:osvaldoreisss/rnaseq_analysis_kallisto_deseq2.git` or `git remote add -f upstream https://github.com/osvaldoreisss/rnaseq_analysis_kallisto_deseq2.git` if you do not have setup ssh keys.
